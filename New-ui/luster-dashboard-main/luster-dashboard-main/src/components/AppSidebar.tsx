...
import { LayoutDashboard, Package, Tags, ShoppingCart, Users, CreditCard, BarChart3, Settings, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    <>
      ...
      >
        <div className="h-16 flex items-center justify-center border-b border-border shrink-0">
          {!collapsed && <span className="font-bold gradient-text text-lg">Navigation</span>}
        </div>
